...
exports.formatMessage = exports.messages = void 0;
exports.messages = {
    success: {
        ...
        RECOVERY_EMAIL_SENT: 'E-mail enviado! Confira sua caixa de entrada para redefinir sua senha. Se não encontrar, verifique também a pasta de spam',
    ...
    errors: {
        ...
        PASSWORD_TOO_WEAK: 'A senha deve ter pelo menos 8 caracteres, conter letras maiúsculas, minúsculas, números e caracteres especiais.',
        ...
        ACCOUNT_NOT_ACTIVE: 'Conta não ativada. Verifique seu e-mail para ativação.',
        ...
        INVALID_EMAIL_FORMAT: 'O e-mail deve estar em um formato válido, como exemplo@dominio.com.',
        PASSWORD_RECOVERY_REQUEST_NOT_FOUND: 'Não há nenhum pedido de recuperação de senha em andamento. Por favor, inicie o processo para solicitar a recuperação.'
    },
    general: {
